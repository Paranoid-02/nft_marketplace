...
const PaymentBodyCmp = ({ nft, nftCurrency }) => (
  <div className="flex flex-col">
    ...
    <div className="flexBetweenStart mt-5">
    ...
    <div className="relative flex justify-center md:flex-col min-h-screen">
      ...
      <div className="flex-1 justify-start sm:px-4 p-12 sm:pb-4">
        <div className="flex flex-row sm:flex-col">
          <h2 className="font-poppins dark:text-white text-nft-black-1 font-semibold text-2xl minlg:text-2xl">{nft.name}</h2>
        </div>
        <div className="mt-10">
          <p className="font-poppins dark:text-white text-nft-black-1 text-xs minlg:text-base font-normal">Creator</p>
          <div className="flex flex-row items-center mt-3">
            <div className="relative w-12 h-12 minlg:h-20 mr-2">
              <Image
                src={images.creator1}
                objectFit="cover"
      ...
      <Modal
        ...
        body={(
          <div className="flexCenter flex-col text-center" onClick={() => setSuccessModal(false)}>
            ...
            <p className="font-poppins dark:text-white text-nft-black-1 font-normal text-sm minlg:text-xl mt-10">You successfully purchased <span className="font-semibold">{nft.name}</span> from <span className="font-semibold">{nft.seller}</span>
            </p>
          </div>
        )}
        footer={(
          <div className="flexCenter flex-col">
            <Button
              ...
              classStyles="sm:mr-5 sm:mb-5 rounded-xl"
